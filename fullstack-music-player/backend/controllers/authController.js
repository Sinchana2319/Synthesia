...
const signup = async (req , res) => {
    try {
        ...
        console.error("Signup not succesfull");
...
const login = async (req, res) => {
    try {
        ...
        console.error("Login not succesfull",error.message);
...
const resetPassword = async (req, res) => {
    try {
        ...
        if(!user)
            return res.status(400).json({ mesage: "Token is invalid or expired" });
    ...
    try{
        ...
        if(currentPassword || newPassword){
            ...
            if(!isMatch) {
                return res
                .status(400)
                .json({ message: "Current password is incorret "});
            }
