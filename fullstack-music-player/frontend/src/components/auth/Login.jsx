...
const Login = () => {
    ...
    const handleForgotPassword  = async () => {
        ...
        try {
            ...
            setForgotMsg(
                error?.response?.data?.message || "Reset link sent! Check your email",
            );
        }
    };
    ...
    return(
        ...
        <div className="forgot-wrapper">
            {!isForgot ? (
                ...
                <div className="forgot-box">
                    <Input 
                        ...
                        value={forgotEmail}
                        onChange={(e) => setForgotEmail(e.target.
                        value)}
                    />
            ...
            {error && <div className="login-error">{error}</
            div>}
            {!isForgot && (
                <button
                    type="submit"
